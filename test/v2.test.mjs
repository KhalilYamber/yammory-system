...
test('F9：面板路由只读——entries（含预算）与 audit（上限钳制）', async (t) => {
  ...
  assert.deepEqual(routes.map((route) => route.path).sort(), ['/api/memento/audit', '/api/memento/batches', '/api/memento/entries', '/api/memento/proposals', '/api/memento/session', '/api/memento/stats', '/api/memento/tidy-request'])

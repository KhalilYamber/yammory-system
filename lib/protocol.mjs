...
export class MemoryProtocolCore {
   ...
   * @returns {{batchId: string, rows: object[], sourceIds: string[], producedIds: string[], source: string | null, sessionId: string | null, startedAt: number, endedAt: number, entries: ProtocolEntry[]} | null} 批次报告；未知批次为 null。
   */
  batchReport(batchId) {

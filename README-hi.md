...
**आपका सहायक वह पूछना बंद कर देता है जो उसे पहले से पता होना चाहिए।**

वह सत्रों के पार आपको याद रखता है — हर विषय में आप किस स्तर तक हैं, आपसे किस लहज़े में बात करनी है, क्या-क्या तय हो चुका है — और आपकी अनुमोदन के बिना कोई लेखन नहीं होता, इसलिए आपके बारे में कुछ भी आपकी पीठ पीछे जमा नहीं होता।
...
<sub>वितरण: केवल GitHub चैनल — कोई npm पैकेज नहीं, कोई मार्केटप्लेस लिस्टिंग नहीं।</sub>
...
एक काबिल सहायक भी भूलने की बीमारी वाला सहायक ही रहता है। हर सत्र में वह शून्य से शुरू करता है: उसे नहीं पता कि आप eigenvector समझ चुके हैं पर tensor network कभी छुआ नहीं, कि आप तारीफ़ से पहले सुधार पसंद करते हैं, और यह भी नहीं कि तीन हफ़्ते पहले आपने वह रास्ता न चुनने का फ़ैसला किया था। तो आप खुद को बार-बार नए सिरे से परिचित कराते हैं, और जो बातचीत दिलचस्प हिस्से से शुरू हो सकती थी, वह शून्य से शुरू होती है।

`yammory_system` DeepSeek Harness को वह ज्ञान रखने की जगह देता है, और अनुमान लगाए बिना उसका उपयोग करने का तरीक़ा भी। तीन बातें इसे एक मेमोरी-भंडार से अलग करती हैं:

- **बोलने का तरीक़ा पहले तय होता है, खोज बाद में।** सात-फ़ेसट प्रोफ़ाइल में प्रति-क्षेत्र ज्ञान स्तर होता है, इसलिए जवाब देने से पहले ही सहायक को पता रहता है कि आप कौन-सी शब्दावली सँभाल सकते हैं — इंजेक्शन प्रॉम्प्ट संयोजन के समय होता है, किसी रिट्रीवल चरण के बाद नहीं।
- **आपके बिना कुछ नहीं लिखा जाता।** हर लेखन पथ सेवा के भीतर DSH के अपने अनुमोदन द्वार से गुज़रता है। अस्वीकृत लेखन भी प्रमाण छोड़ता है; चुपचाप लिखा जाना वह अवस्था नहीं जहाँ यह प्लगइन पहुँच सके।
- **उसका काम आप जाँच सकते हैं।** मॉडल ने जो-जो देखा, सब दर्ज है, भंडार एक साधारण SQLite फ़ाइल है जिसे आप ब्राउज़, निर्यात और ऑडिट कर सकते हैं, और ग़लतियों की एक पूरी श्रेणी अनुशासन से नहीं, डिज़ाइन से रुकती है।
...
रीस्टार्ट के बाद, बिना कुछ कॉन्फ़िगर किए, आपको यह दिखना चाहिए:

| कहाँ | क्या |
|---|---|
| साइडबार का निचला हिस्सा | सेटिंग्स के बग़ल में एक **मेमोरी** प्रविष्टि (यह ड्रॉअर खोलती-बंद करती है; `panel.enabled` से छिपाई जा सकती है) |
| वार्ता शीर्षक-पट्टी | प्रति-सत्र मेमोरी स्विच — बंद करने पर उस सत्र का इंजेक्शन, रिकॉल, लेखन और अवलोकन रुक जाता है |
| साइडबार का निचला हिस्सा → वही प्रविष्टि | ड्रॉअर: ट्रैक और परत के अनुसार प्रविष्टियाँ, खोज, चेतावनी-रेखाओं का उपयोग, हाल का ऑडिट, तीन अवलोकनीय संख्याएँ, और एक **पूरी लाइब्रेरी साफ़ करें** बटन जो केवल एक मार्कर कतार में डालता है |
| DSH सेटिंग्स → `yammory-system` | हर कॉन्फ़िग फ़ील्ड, हर एक के साथ एक प्रश्नचिह्न जो उसे सरल शब्दों में समझाता है |
| `/memory` | `list`, `query`, `stats`, `audit`, `session on|off`, `export` / `import <path>`, और भी बहुत कुछ |
...
- **परिबद्ध और ईमानदार।** प्रति-ट्रैक/प्रति-परत कोमल चेतावनी-रेखाएँ (डिफ़ॉल्ट user 2000 / agent 4000)। रेखा पार करने पर लेखन कभी नहीं रुकता — केवल संकेत मिलता है कि वह परत समेकित करने योग्य है। कभी काटा नहीं, कभी स्वतः संकुचित नहीं।
- **प्रति-सत्र स्विच।** हर सत्र का अपना मेमोरी स्विच (प्लगइन का अपना SQLite टेबल, स्कीमा v6; डिफ़ॉल्ट रूप से चालू)। बंद करने पर चार चीज़ें एक साथ रुकती हैं: इंजेक्शन (जमा हुआ वॉर्म-अप ब्लॉक तुरंत हट जाता है), रिकॉल (`SESSION_MEMORY_OFF`), लेखन (अनुमोदन द्वार की उसी परत पर अस्वीकृत) और अवलोकन (सत्र स्कैन नहीं होता, इतिहास में भी नहीं चुना जाता)। प्रबंधन-पठन (`/memory list` / `budgets` / `audit` / `export`) उपलब्ध रहते हैं। `/memory session on|off` या कंपोज़र के स्विच से बदलें; स्विच की स्थिति कभी सत्र लॉग में नहीं जाती और उसकी ऑडिट पंक्तियों में `text: null` रहता है।
- **देखना, और देखने को ख़ुद चलने देना।** अवलोकन चैनल आपके ही पुराने संदेशों का एक सीमित हिस्सा पढ़ता है और ऐसी व्यवहार-प्रविष्टियाँ लिखता है जो प्रश्नावली तक नहीं पहुँचती; अब एक केवल-पढ़ने वाली जाँच बताती है कि पिछला अवलोकन एक सप्ताह से अधिक पुराना है (एक `observe-due` ऑडिट पंक्ति और अगले वार्म-अप ब्लॉक के अंत में एक पंक्ति), और साप्ताहिक निर्धारित राउंड इसे एक ही कार्यक्षेत्र में बिना किसी की मौजूदगी के चला सकता है: एक हेडलेस `dsh` सत्र स्कैन करता है, अधिकतम तीन साक्ष्य-सहित प्रविष्टियाँ निकालता है और उन्हें उसी अनुमोदन द्वार से लिखता है, जिसकी अनुमति उसका अपना राइट-पॉलिसी स्रोत (`source:observation`, `auto` / `ask` / `off`) देता है। प्लगइन के अंदर कोई टाइमर नहीं रहता; शेड्यूल एक Windows Task Scheduler प्रविष्टि है, ठीक सफ़ाई राउंड की तरह।
- **सफ़ाई और माप।** मॉडल द्वारा चलाई गई सफ़ाई उन प्रविष्टियों को, जो एक ही बात कहती हैं, `merged` टैग वाली एक प्रविष्टि में मिला देती है और पुरानी को `superseded` कर देती है: वे डिस्क पर रहती हैं, किसी भी सत्र की दृश्य-सूची से बाहर, कभी मिटाई नहीं जातीं। यह कभी बाल्टी नहीं लाँघती (`track × scope × agentKey`, workspace परत पर साथ में `workspaceKey`) और कभी अपने आप नहीं चलती। कोई विलय बिना किसी व्यक्ति के लिखा जा सकता है या नहीं, यह पाँच यांत्रिक कसौटियाँ तय करती हैं (एक ही बकेट / सदस्य संख्या / विराम-चिह्न, रिक्त स्थान और प्रतीक हटाने के बाद अक्षरशः समानता / समानता-स्कोर / कवरेज), मॉडल का स्वयं घोषित भरोसा नहीं: केवल वही श्रेणी `auto` मानी जाती है जिसके सदस्य विराम-चिह्न, रिक्त स्थान और प्रतीक हटाने पर समान हों, और वह बिना किसी की निगरानी में लिखी जा सकती है, जबकि पूरी तरह पुनर्लिखित समानार्थी जोड़ी `review` रेखा से भी नीचे रहती है और सीधे `skip` मानी जाती है, तथा एक अक्षर का बदलाव `review` में जाता है और इंटरैक्टिव रास्ता माँगता है। इसलिए एक पृष्ठभूमि दौर (आपके ही शेड्यूलर द्वारा जगाई गई हेडलेस `dsh` सत्र) यांत्रिक रूप से निर्विवाद दोहराव स्वयं मिला सकती है, और बाकी आपकी प्रतीक्षा में छोड़ देती है। लेखन अपना ऑडिट स्रोत स्वयं पिन करता है (`tidy-auto`), इसलिए बारीक लेखन-नीति (`source:tidy-auto`) ठीक उसी एक रास्ते को खोल सकती है और शेष लेखन स्वीकृति द्वार के पीछे रहते हैं। अलग से, `agent/turn-stopping` पर एक केवल-पठन जाँच केवल यह बताती है कि बैकलॉग रेखा पार कर गया (एक `tidy-due` ऑडिट पंक्ति और अगले वॉर्म-अप ब्लॉक के अंत में एक पंक्ति)। `/memory stats` तीन अवलोकनीय संख्याएँ बताता है (पुनरावृत्ति दर, रिकॉल हिट दर, इंजेक्शन मात्रा), और पैनल में वही तीन पंक्तियाँ दिखती हैं; सफलता दर जानबूझकर खाली छोड़ी गई है, क्योंकि इस रिपॉज़िटरी के पास «इंजेक्ट किया गया ब्लॉक वाकई समझा गया?» का कोई संकेत-स्रोत नहीं है। पैनल का **पूरी लाइब्रेरी साफ़ करें** बटन एक कतार है, क्रिया नहीं: यह उसी अनुमोदन नीति के तहत एक ही मार्कर पंक्ति (`tidy_requests`, schema v7) लिखता है, अगले सत्र का वॉर्म-अप मॉडल से पूरी लाइब्रेरी की सफ़ाई माँगता है, और जब सचमुच कोई सफ़ाई-लेखन होता है तब मार्कर `done` हो जाता है: पैनल से कुछ भी विलीन नहीं होता।

- **मेमोरी का शासन: रद्द की गई प्रविष्टि वापस लाएँ, टकराव का फ़ैसला फ़ेसट के अनुसार करें।** `restore` रद्दीकरण को उलटी दिशा में ले जाता है (`superseded → active`, `version` अपरिवर्तित, हर सत्र की दृश्य-सूची में वापस) और रद्द अवस्था से निकलने का यही एकमात्र रास्ता है। `arbitrate` उस स्थिति का फ़ैसला करता है जहाँ एक ही तथ्य के दो स्रोत हों: फ़ैसला **एक ही फ़ेसट** पर होता है और दिशा एक निश्चित तालिका से आती है — क्षमता अवलोकन की बात मानती है, पसंद स्वयं-कथन की, और शेष पाँच फ़ेसट **दोनों** प्रविष्टियाँ रखती हैं और हर एक पर `gap` टैग लगाती हैं (अंतर ही साक्ष्य है)। तालिका ही दिशा है, इसलिए उलटा तर्क देने का कोई रास्ता नहीं, और एक समूह के भीतर सबसे हाल में अद्यतन प्रविष्टि रखी जाती है। दोनों क्रियाएँ उसी अनुमोदन द्वार, उसी प्रति-सत्र स्विच और उन्हीं बाल्टी नियमों से गुज़रती हैं जिनसे हर लेखन, और दोनों ऑडिट छोड़ती हैं: `restore` प्रति प्रविष्टि, `arbitrate` प्रति रद्दीकरण (`text: null`, केवल id), `arbitrate-tag` प्रति टैग, और अंत में एक `arbitrate` सारांश जो बताता है कौन रखा गया, कौन रद्द हुआ और क्यों।
...
| `panel.enabled` | `true` | साइडबार के निचले हिस्से की मेमोरी प्रविष्टि दिखाएँ; सेटिंग्स पृष्ठ से `false` सेव करने पर वह तुरंत छिप जाती है, रीलोड की ज़रूरत नहीं (सेटिंग्स पृष्ठ अप्रभावित) |
...
| `recall.weighting.heat` | `0.3` | हीट बोनस की ऊपरी सीमा (गुणात्मक; `0` = बंद)। हीट = रिकॉल (संतृप्त) × अंतिम रिकॉल के बाद की अर्ध-आयु क्षय: हीट बनाए रखने के लिए लगातार रिकॉल होते रहना ज़रूरी है |
| `recall.weighting.heatSaturation` | `10` | हीट बोनस संतृप्त करने वाले रिकॉल |
| `recall.weighting.heatHalfLifeDays` | `14` | हीट अर्ध-आयु (दिन) |
| `recall.weighting.freshness` | `0.2` | ताज़गी बोनस की ऊपरी सीमा (गुणात्मक; `0` = बंद) |
| `recall.weighting.freshnessHalfLifeDays` | `30` | ताज़गी अर्ध-आयु (दिन) |
| `recall.weighting.tagDiscount` | `0.5` | टोकन का भार जब वह केवल `tags` में मिले (मुख्य पाठ में मिलने पर `1`) |
| `retrieval.vector` | `false` | सिमेंटिक रिकॉल स्विच: `true` वेक्टर रिकॉल तभी चालू करता है **जब वास्तव में सिमेंटिक एम्बेडिंग प्रदाता पंजीकृत हो** — हैश/फ़ेक प्रदाता जानबूझकर पर्याप्त नहीं, क्योंकि वह अर्थ का मॉडल नहीं करता और CJK रिकॉल चुपचाप शून्य कर देगा। अन्यथा शून्य-निर्भरता keyword रिट्रीवर बना रहता है (CJK बाइग्राम, किसी भी टोकन पर मिलान, हीट/ताज़गी भार, प्रासंगिकता क्रम) |
...
| Surface | Kind | Notes |
|---|---|---|
| `memory` | tool | Save/Skip मार्गदर्शन के साथ add/replace/remove/consolidate/supersede/auto-tidy/restore/arbitrate/query/tidy; प्रविष्टियाँ वैकल्पिक प्रोफ़ाइल निर्देशांक रख सकती हैं (`facet` = सात में से एक, `level` = प्रति-क्षेत्र ज्ञान स्तर); `supersede` 1..20 प्रविष्टियों को `merged` टैग वाली एक प्रविष्टि में मिलाता है और पुरानी को `superseded` कर देता है (रखी जाती हैं, कभी मिटाई नहीं जातीं), `restore` रद्द की गई प्रविष्टि वापस लाता है, `arbitrate` एक फ़ेसट पर दो स्रोतों के टकराव का फ़ैसला निर्धारित तालिका की दिशा से करता है, `tidy` केवल-पठन योजना देता है; लेखन अनुमोदन द्वार से गुज़रता है |
...
| `yammory-tidy` | skill | उपयोगकर्ता द्वारा शुरू की गई मेमोरी-सफ़ाई: केवल-पठन योजना पढ़ता है, जो एक ही बात कहती हैं उन्हें एक में मिलाता है और पुरानी प्रविष्टियों को `superseded` कर देता है (रखी जाती हैं, कभी मिटाई नहीं जातीं), बाल्टी कभी नहीं लाँघता। स्रोत: `skills/yammory-tidy/`; निर्णय-नियम `references/merge-rules.md` में |
| `yammory-experience` | skill | काम की पुनरुपयोगी सीखों को `agent` ट्रैक (पर्यावरण-तथ्य, परंपराएँ, सबक़) में दर्ज करता है, उपयोगकर्ता प्रोफ़ाइल से एक ही प्रश्न पर अलग: क्या यह जानकारी हर बार मौजूद रहनी चाहिए? स्रोत: `skills/yammory-experience/` |
...
| session switch | session header | वार्ता शीर्षक-पट्टी में, एजेंट प्रीसेट लेबल के ठीक बाद प्रति-सत्र मेमोरी स्विच (`conversation.session.header.actions`, सत्र स्कोप): वर्तमान स्थिति दिखाता है और `GET`/`POST /api/memento/session` से बदलता है (पैनल रूटों वाली वही `connection.fetch` भरोसा-बाड़) |
| web panel | client drawer | केवल-पठन, दो दुनियाओं में बँटा: **मेमोरी** टैब सात-पक्षीय संकुचनशील वृक्ष है (पहले श्रेणियाँ, क्लिक पर प्रविष्टियाँ) और एक ज्ञान-स्तर ब्लॉक; **अनुभव** टैब `agent` ट्रैक को विषय के अनुसार बाँटता है। दोनों में खोज, बजट बार, तीन अवलोकनीय संख्याएँ और ऑडिट पूँछ साझा हैं; एक उपयोगकर्ता-क्रिया बटन केवल पूरी लाइब्रेरी की सफ़ाई कतार में डालता है; साइडबार प्रविष्टि छिपाई जा सकती है (`panel.enabled`) |
...
# या, GitHub चैनल से पैकेज इंस्टॉल होने के बाद: npx yammory_system-mcp
# (यह रेपो अभी npm रजिस्ट्री पर नहीं है; ऊपर का -p github:… ही स्रोत है)
```
...
- **«सिमेंटिक» कहलाने वाला रिकॉल का आधा हिस्सा अभी सिमेंटिक नहीं है।** `retrieval.vector` तभी काम करता है जब कोई ऐसा एम्बेडिंग प्रदाता पंजीकृत हो जो स्वयं को सिमेंटिक घोषित करे, और यहाँ जो एकमात्र प्रदाता भेजा गया है वह `false` घोषित करता है, इसलिए आज यह स्विच डिज़ाइन के अनुसार keyword रिकॉल पर लौट आता है। सच्चा सिमेंटिक रिकॉल चालू करने के लिए एक ऐसा एम्बेडिंग स्रोत चाहिए जिसे इस रिपॉज़िटरी ने अभी चुना नहीं है।

## How it's different

| Plugin | यह क्या है | yammory_system का अंतर |
|---|---|---|
| dsh-mneme | स्व-विकसित मेमोरी, विस्तृत फ़ीचर-सतह | केवल छोटे-कोर्पस प्रोफ़ाइल: यह उपयोगकर्ता के मापे गए स्तर पर बोलकर अलग दिखता है, फ़ीचर बढ़ाकर नहीं |
| dsh-meow-memory | सात-परत स्टोर, BM25 रिट्रीवल | कोई रिट्रीवल इंजीनियरिंग नहीं: प्रति-क्षेत्र स्तर तालिका और फ़ेसेट मध्यस्थता |
| dsh-persona-memory | प्रॉम्प्ट में पर्सोना इंजेक्शन | एक परत आगे: स्थायी प्रोफ़ाइल के ऊपर **प्रति-क्षेत्र ज्ञान स्तर** और **फ़ेसेट मध्यस्थता** |
...
आज जो दो अंतर टिकते हैं वे तालिका की आख़िरी जोड़ी हैं: **प्रति-क्षेत्र ज्ञान स्तर वाली सात-फ़ेसेट प्रोफ़ाइल** (किसी भी रिट्रीवल से पहले तय करती है कि सहायक किस लहज़े में बोले) और **फ़ेसेट मध्यस्थता** (एक ही तथ्य के दो स्रोतों का फ़ैसला कैसे हो: क्षमता अवलोकन मानती है, प्राथमिकता स्व-कथन मानती है, बाक़ी पाँच फ़ेसेट दोनों रखते हैं और हर एक पर `gap` लगाते हैं)।

नाम **`yammory_system`** है (GitHub चैनल से इंस्टॉल; अभी npm रजिस्ट्री पर नहीं)। `dsh-recall` नहीं (dsh-external/Recall से भ्रमित होने वाला), न ही हटाया गया विरासत नाम `dsh-memory`।

...
| web panel | client drawer | सामग्री के लिए केवल-पठन: प्रविष्टियाँ ब्राउज़ करें, खोजें, बजट बार, तीन अवलोकनीय संख्याएँ, ऑडिट पूँछ; एक उपयोगकर्ता-क्रिया बटन केवल पूरी लाइब्रेरी की सफ़ाई कतार में डालता है; फ़्लोटिंग बटन छिपाया जा सकता है (`panel.enabled`) |

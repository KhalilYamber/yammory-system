...
| session switch | composer dock | कंपोज़र के नीचे प्रति-सत्र मेमोरी स्विच (`conversation.composer.dock`, सत्र स्कोप): वर्तमान स्थिति दिखाता है और `GET`/`POST /api/memento/session` से बदलता है (पैनल रूटों वाली वही `connection.fetch` भरोसा-बाड़) |
